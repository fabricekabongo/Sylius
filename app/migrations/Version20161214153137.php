...
class Version20161214153137 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO sylius_product_variant_translation (translatable_id, name, locale) SELECT id, name, '' as locale from sylius_product_variant WHERE sylius_product_variant.name IS NOT null");
